...
lyr_onedaytrip_1.set('fieldLabels', {'id': 'hidden field', 'name': 'header label - always visible', 'picture': 'header label - always visible', });
lyr_naturetrip_2.set('fieldLabels', {'id': 'hidden field', 'name': 'header label - always visible', 'picture': 'header label - always visible', });
lyr_tripto9temples_3.set('fieldLabels', {'id': 'hidden field', 'name': 'header label - always visible', 'picture': 'header label - always visible', });
lyr_cafekhaotaozone_4.set('fieldLabels', {'id': 'hidden field', 'name': 'header label - always visible', 'picture': 'header label - always visible', });
lyr_beachtripinhuahin_5.set('fieldLabels', {'id': 'hidden field', 'name': 'header label - always visible', 'picture': 'header label - always visible', });
